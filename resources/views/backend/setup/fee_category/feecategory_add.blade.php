            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Add FeeCategory Name<img src="{{ asset('backend/images/favcon.ico') }}" alt=""
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <h5>FeeCategory Name <span class="text-danger">*</span></h5>
                                                        <div class="controls">
