...
@section('title')
    Promotion Student Registration page
@endsection
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Promotion Student<img src="{{ asset('backend/images/favcon.ico') }}"
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col">
                                <form action="{{ route('student.promotion',['student_id'=>$assign_student->student_id]) }}" method="post"enctype="multipart/form-data">
                                    @csrf
