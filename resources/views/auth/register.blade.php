					...
					<div class="col-lg-4 col-md-5 col-12">
						...
						<div class="p-30 rounded30 box-shadowed b-2 b-dashed"style="box-shadow: rgba(50, 50, 93, 5) 0px 13px 27px -5px, rgba(0, 0, 0, 3) 0px 8px 16px -8px !important;">
							<form action="{{ route('register') }}" method="post">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input id="name" name="name" type="text" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Full Name">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text bg-transparent text-white"style="background:red !important"><i class="ti-email"></i></span>
										</div>
							...
							<div class="text-center">
								<p class="mt-15 mb-0 text-white">Already have an account?<a  href="{{ route('login') }}" class="text-primary  ml-5"> Sign In</a></p>
							</div>
						</div>
					</div>
				</div>
